...
for i in range(Array_new.shape[0] - 1):
    for j in range(Array_new.shape[1] - 1):
        for k in range(Array_new.shape[2] - 1):
            ...
            #Array_prediction[0][0] = Array_new[i][j][k]
            #Array_prediction[0][2] = Array_new[i][j + 1][k]
            #Array_prediction[0][1] = Array_new[i][j][k + 1]
            #Array_prediction[0][3] = Array_new[i][j + 1][k + 1]
            #Array_prediction[0][4] = Array_new[i + 1][j][k] 
            #Array_prediction[0][6] = Array_new[i + 1][j + 1][k]
            #Array_prediction[0][5] = Array_new[i + 1][j][k + 1]
            #Array_prediction[0][7] = Array_new[i + 1][j + 1][k + 1]

            Array_prediction[0][0] = Array_new[i + 1][j][k]
            Array_prediction[0][1] = Array_new[i + 1][j][k + 1]

            Array_prediction[0][2] = Array_new[i][j][k]
            Array_prediction[0][3] = Array_new[i][j][k + 1]

            Array_prediction[0][4] = Array_new[i + 1][j + 1][k]
            Array_prediction[0][5] = Array_new[i + 1][j + 1][k + 1]

            Array_prediction[0][6] = Array_new[i][j + 1][k]
            Array_prediction[0][7] = Array_new[i][j + 1][k + 1]
