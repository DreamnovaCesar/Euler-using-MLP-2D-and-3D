...
class DataPlotterDL(DataPlotter):
    ...
    def plot_data_loss(
        ...
        Figure_name = "Figure_Loss_{}.png".format(Model_name)
        Figure_name_folder = os.path.join(Folder_data, Figure_name)
    ...
    def plot_data_accuracy(
        ...
        # * Set the name of the figure to be saved and set the folder to save the figure
        Figure_name = "Figure_Accuracy_{}.png".format(Model_name)
        Figure_name_folder = os.path.join(Folder_data, Figure_name)
