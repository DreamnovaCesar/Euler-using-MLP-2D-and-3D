...
class MLPOptionGeneratorAWS(MenuOption):
    ...
    def __init__(
        self, 
        Euler_generator_AWS : EulerObjectGeneratorAWS
    ):
        ...
        self.Euler_generator_AWS = Euler_generator_AWS;
    ...
    def execute(self):
        ...
        print("Enter the following parameters to generate the Euler object samples and save them in AWS:")
        print('\n');
        while True:
            ...
            if user_exit == "n":
                ...
                if user_input == "n":
                    ...
                    Euler_generator_AWS = self.Euler_generator_AWS(
                        self.Folder_path,
                    ...
                    Euler_generator_AWS.generate_euler_samples_settings();
