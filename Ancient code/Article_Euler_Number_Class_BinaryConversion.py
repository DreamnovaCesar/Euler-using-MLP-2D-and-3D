...
class BinaryConversion(Utilities):
    ...
    ----------
    Iter : int
        The number of iterations for the binary conversion.
    ndim : str
        The dimensionality of the output list.
    ...
    def __init__(self, Iter: int, ndim: str = '2D') -> None:
        ...
        ndim : str 
            The number of dimensions in the output list, either '2D' or '3D'. Defaults to '2D'.
        """
    ...
    def decimal_to_binary(Decimal_value: int) -> str:
        ...
        -------
        int 
            The binary representation of Decimal_value as an integer.
        """
    ...
    def decimal_to_binary_list(self) -> None:
        ...
        ----------
        Number_iter : int
            The maximum decimal value to convert to binary.
        ndim : str
            The number of dimensions in the output list, either '2D' or '3D'. Defaults to '2D'.
        ...
        ----------
        np.ndarray 
            A numpy array containing the binary representations of the decimal values.
        """
